...
par(mfrow=c(2,2))
#graph 1
plot(house_consumption$datetime,house_consumption$Global_active_power, type="l", col ="red", bg ="transparent", xlab="", ylab="Global Active Power")
#graph 2
plot(house_consumption$datetime,house_consumption$Voltage, type="l", col ="black", bg ="transparent", xlab="datetime", ylab="Voltage")
#grap 3
